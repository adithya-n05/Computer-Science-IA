...
public class Student extends Person implements Serializable{
    ...
    private ArrayList<HomeworkNode> homeworkTracker = new ArrayList<HomeworkNode>();
    ...
    public ArrayList<HomeworkNode> getHomeworkTracker() {
        return homeworkTracker;
    }

    public void setHomeworkTracker(ArrayList<HomeworkNode> homeworkTracker) {
